...
module.exports = {
  insertJudementResult(req, res) {
    ...
    userDao.insertJudementResult([JUDGMENT_RESULT_NUMBER, TYPE_OF_PENALTY, PENALTY_PERIOD, IS_PROBATION, FINE_AMOUNT, IS_ILLEGAL_INCOME, LIGHT_PLOT, SUSPECT_NUMBER], (err, data) => {
      if (err) {
        res.status(500).send();
      } else {
